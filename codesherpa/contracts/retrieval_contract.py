...
Implemented by ``codesherpa.retrieve`` (Phase 3) and consumed by the MCP server
...
class Retriever(ABC):
    """Retrieval interface over an :class:`~codesherpa.contracts.index_contract.IndexStore`."""
