"""repograph MCP server (stdio) — CLAUDE.md §7.6.
...
from repograph.contracts.types import SearchResult
from repograph.graph.gitio import git_output
from repograph.graph.recent import recent_changes as _recent_changes
...
def create_server(
    ...
    def index_status() -> str:
        ...
        Check this if results look stale, then run `repograph sync`."""
